...
```
3. result
![](attachment/ad6aeb5279b675d7e9059c0a237a2fd3.png)
![](attachment/e93c1c9715ac60bb573dff2d805ff6c1.png)
## 1.2. TCP
1. TCPClient.py
```python
from socket import*
...
```
3. result
![](attachment/c35cfd0227d5a85385ed4ec273af3c8e.png)
![](attachment/9dbdab3fe3d049875c34e21b56a2bde3.png)
# lab1  Web-Server
## 2.1. Web-Server.py
```python
...
```
## 2.2. result
![](attachment/413b22962afb7e0a05c99a6b2663139f.png)
# lab3 UDPPinger
...
```
## 3.3. result
![](attachment/74e8a02e61f32df5efa4d22b1d92b233.png)
# lab4 SMTP-Client
...
![](attachment/b33d5322851ce8be0201013b6348a331.png)
# lab5 ProxyServer
## 5.1. setback road
...
![](attachment/010ebfd181aef963fb5dc1ee0e4d6c8c.png)
client端获取成功
![](attachment/b311d99e137e0737fee01f705f1f02a8.png)
此时wireshark-labs目录下已经多了一个缓存文件
![](attachment/db6ca4c65166d4a1cda7e465689748eb.png)
再次访问proxy server，可以看到代理服务器直接返回了已缓存的文件
![](attachment/51c4634ee69a357a132cb7d1c05dc65e.png)
client端获取成功
![](attachment/b763c137d8a41fca75d9cbc4c7da7c1d.png)
...
![](attachment/89b16b7b14b82b04ee59f46aab1a6b85.png)
接受方的FSM，用B_status的2个值表示2种状态
![](attachment/c3563a3317ec4f89aa04e5d5b7b003d9.png)
### 1.2. source code
```c
#include <stdio.h>
#include <string.h>
...
![](attachment/ccfe78ace391eb03d86554132cc0c2a0.png)
...
![](attachment/5b35c846e62834a821321e293a9e051d.png)
![](attachment/37f5283f60325d87878bbd777a9bb644.png)
![](attachment/d5f2639399ae272b158f370885f2fbaa.png)
## 2. Go-Back-N
### 2.1 analyze
...
![](attachment/32d267d6b7b57841c28884749ca8b64b.png)
...
![](attachment/276f5e6671463694fb72993989cb865e.png)
...
![](attachment/e9228d9752502d65958cd87a1152e3c4.png)
![](attachment/558c8c6a161ba3715fdf367a10d34721.png)
...
![](attachment/1946975b88b4b65d58c88ded1a62c5b8.png)
#### 2.2. loss and corruption
下面将分析部分输出来验证代码的正确性
...
![](attachment/f29d4e4a3d2c09fa475072d991d20b95.png)
![](attachment/f70a5a55e0094826761fe3bdbcfc841b.png)
...
![](attachment/6dff28c981d2c604e4bcbca86ed88d93.png)
